      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 shrink-0 shadow-2xs">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-black text-slate-800">Cloud Data Synchronization Hub</h2>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Decentralized multi-location replication with offline-first failover resilience
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs transition flex items-center gap-1.5 cursor-pointer disabled:cursor-not-allowed"
          >
            <RefreshCw className={`w-3.5 h-3.5 ${syncStatus === 'syncing' ? 'animate-spin' : ''}`} />
            <span>Sync All Branches Now</span>
          </button>
        </div>
      </div>
